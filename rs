...
<div class="container" id="content">
  ...
  <div class="row">
    ...
    <div class="col-sm-4" >
      <a onclick =gtag_report_conversion() href="https://flipchat.in/south" target="_blank">
        <img class="image" src="southbanner.png" alt="Lord 365"></a>
        <p class="disclaimer text-center">
          ...
          <a target="_blank" onclick =gtag_report_conversion() href="https://flipchat.in/south" class="enq-side-btn-icone"><i class="fab fa-whatsapp">

          </i> Click to Whatsapp Now</a>
          <a target="_blank" onclick =gtag_report_conversion() href="https://flipchat.in/south" class="enq-side-btn-icone-whatsapp">
